...
- `earth_normal_map_8k.tif` / `earth_normal_map_8k.png` / `earth_normal_map_8k.webp`: Solar System Scope Earth Normal Map texture, converted to PNG fallback and lossless WebP for modern browser loading. Source: https://www.solarsystemscope.com/textures/
...
- `earth_bedrock_bathymetry_normal_8k.png` / `earth_bedrock_bathymetry_normal_8ki.webp`: generated from NOAA ETOPO1 Bedrock global relief, including ocean bathymetry. PNG remains the fallback; lossless WebP is used by modern browsers. Source: https://www.ngdc.noaa.gov/mgg/global/relief/ETOPO1/data/bedrock/grid_registered/georeferenced_tiff/
...
- `moon_bump_lola_4k.jpg` / `moon_normal_lola_4k.png` / `moon_normal_lola_4k.webp`: derived browser-ready bump and normal maps generated from the NASA Scientific Visualization Studio CGI Moon Kit LOLA elevation map. PNG remains the fallback; lossless WebP is used by modern browsers. Source: https://svs.gsfc.nasa.gov/4720/
